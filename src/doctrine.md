...
Wardley’s Doctrine is a collection of patterns of behaviour that
has been used by Stance to evaluate and underpin its approach to improving
organisations, and ultimately to developing [OSOM](/)

The doctrine doesn’t tell us the precise steps that need to be taken,
but it does help us to understand how we’d like to see organisation
behave: whether it’s assumptions being challenged freely and often,
...
website or a data center, and do we use the right tools?
...
Any value we create is through meeting the needs of others, no matter
who they are.
...
Once something is running and working well, do we look to improve the
efficiency of it so that it becomes less expensive? Or do we rest on
our laurels?
...
Whatever we do will evolve. So we have bias towards the new, we're
...
Instead of long winded plans, we will have direction towards a
...
challenges along the way?  Once we've set a direction we commit to
it.
...
We try to put power in the hands of those who are closest to the
...
We understand that an organization which plans for longevity needs to
...
round pegs, or square holes; we won't grind people down into one way
